...
typedef struct FznsoModelMethods {
   ...
   * reports, and is free to leave the others open. Nothing else marks a
   * variable as needed — in particular, whether it has a name does not,
   * since names exist only for debugging.
   */
